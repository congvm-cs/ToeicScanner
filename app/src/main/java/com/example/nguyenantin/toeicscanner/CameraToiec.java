...
public class CameraToiec extends Activity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_camera_toiec);
        ...
        String imageUri = "drawable://" + R.drawable.N3;
...
//                        Intent emailIntent = new Intent(CameraToiec.this,CheckPicture.class);
//                        emailIntent.setType(HTTP.PLAIN_TEXT_TYPE);
                        I = Imgcodecs.imread(imageUri, 1);
                        ToeicScanner scanner = new ToeicScanner();
                        I_pre = scanner.Process(I);
                        Log.e(TAG, "Ket qua: " + scanner.GetAnswers().toString());
